...
#
# PLUS...of course the original E-Paper routines#

# I HAVE BASICALLY NO IDEA WHAT ANY OF THIS DOES BUT IT MAKES EPAPER DO LANDSCAPE ORIENTATION

from machine import Pin, SPI
import framebuf
import utime

# idk what this is but apparently it is called as an image in example code 'V(o_o)V'
Beeld = [0XFF] * 4000
...
class EPD_2in13(framebuf.FrameBuffer):
    ...
    # sleep (shuts off power to display) for delaytime number of milliseconds
